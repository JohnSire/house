...
<script type="text/javascript" charset="utf-8"
	src="<c:url value="/js/script_agent.js"/>"></script>
	...
	<div id="content">
		...
		<div id="content-header">
			<div id="breadcrumb">
				...
				</a> <a title="经纪人信息" class="tip-bottom">经纪人信息</a>
			</div>
		</div>
		<!--End-breadcrumbs-->
		<!-- Tabs Container-->
					...
					<form action="<c:url value="${formAction}"/>"
						...
						<section  class="clearfix">
							...
							<ul class="info">
								...
								<li><span>手机</span> :
									<input type="text" value="${agent.phone }" name="phone" 
									id="phone"> <span id="span" style="color: red;">*</span>
								</li>
								<li><span>昵称</span> :
									<input type="tel" value="${agent.nickname}" name="nickname">
									<span id="span" style="color: red;">*</span>
								</li>
								<li >
									<span>性别</span> :
									<c:choose>
										<c:when test="${agent.gender eq 'fmale' }">
